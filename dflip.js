...
(function dFlip(DFLIP, $) {
  ...
  var defaults = DFLIP.defaults = {
    ...
    backgroundImage: "images/bg.jpg",//"images/textures/el.jpg",
...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    if (typeof dFlipLocation !== 'undefined') {
      ...
      DFLIP.defaults.mockupjsSrc = dFlipLocation + "libs/mockup.min.js";
      DFLIP.defaults.pdfjsSrc = dFlipLocation + "libs/pdf.js";
      DFLIP.defaults.pdfjsCompatibilitySrc = dFlipLocation + "libs/compatibility.js";
      DFLIP.defaults.threejsSrc = dFlipLocation + "libs/three.min.js";
      DFLIP.defaults.pdfjsWorkerSrc = dFlipLocation + "libs/pdf.worker.js";
      DFLIP.defaults.soundFile = dFlipLocation + "sound/turn2.mp3";
      DFLIP.defaults.imagesLocation = dFlipLocation + "images";
      DFLIP.defaults.imageResourcesPath = dFlipLocation + "images/pdfjs/";
      DFLIP.defaults.cMapUrl = dFlipLocation + "libs/cmaps/";
